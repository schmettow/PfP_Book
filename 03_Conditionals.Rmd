...
But then, you may ask yourself, how do you implement more than two execution branches, without resorting to nested conditionals? Let's pretend that it is incredibly important to your program that it does make a difference between the case that `a` is larger than 0, compared to when `a` equals 0.
