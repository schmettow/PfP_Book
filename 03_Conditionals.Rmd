...
Here, the numerical expression is evaluated in the context of the Boolean operator   `and` and is converted to Boolean. When that happens, zero becomes `False` and any other valuebecomes `True`, *including negative values* :
