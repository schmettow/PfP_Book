...
In the previous chapter we have dealt with functions as reusable pieces of code. There is another common notion of what a function is: *functions process data*. The basic model of data processing is the following:
...
Consequently, every function that takes arguments and has a return statement can be considered data processing. Furthermore, data processing can take place as chains 
...
* Providing a wrong data type as a function argument. The body of a function is written assuming that you provide the intended data type as argument during a function call. Providing a value of an unintended data type can raise all kinds of follow-up errors.
