...
This course teaches the programming language Python. In order to write Python programs, you need a set of general tools, referred to as the *Python environment*:
  ...
  1. a *Python interpreter*, which runs your code
  1. *Python libraries* libraries, that provide specialized functionality for the task at hand
...
Unfortunately, the authors use Windows computers, so the following instructions are less throughly tested, as compared to a Windows installation.
